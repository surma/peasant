var Module = (() => {
  ...
  return function (Module) {
    ...
    var wasmBinaryFile;
    if (Module["locateFile"]) {
      wasmBinaryFile = "raw.wasm";
      if (!isDataURI(wasmBinaryFile)) {
        wasmBinaryFile = locateFile(wasmBinaryFile);
      }
    } else {
      wasmBinaryFile = new URL("raw.wasm", import.meta.url).toString();
    }
    ...
    var _free = (Module["_free"] = function () {
      return (_free = Module["_free"] = Module["asm"]["J"]).apply(
        null,
        arguments
      );
    });
    ...
    var dynCall_iiji = (Module["dynCall_iiji"] = function () {
      return (dynCall_iiji = Module["dynCall_iiji"] = Module["asm"]["R"]).apply(
        null,
        arguments
      );
    });
    var dynCall_ji = (Module["dynCall_ji"] = function () {
      return (dynCall_ji = Module["dynCall_ji"] = Module["asm"]["S"]).apply(
        null,
        arguments
      );
    });
    var dynCall_jiji = (Module["dynCall_jiji"] = function () {
      return (dynCall_jiji = Module["dynCall_jiji"] = Module["asm"]["T"]).apply(
        null,
        arguments
      );
    });
