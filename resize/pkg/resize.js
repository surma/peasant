...
* @returns {any}
*/
export function resize_u16(input_image, input_width, input_height, factor, resize_type) {
    var ptr0 = passArray16ToWasm0(input_image, wasm.__wbindgen_malloc);
    var len0 = WASM_VECTOR_LEN;
    var ret = wasm.resize_u16(ptr0, len0, input_width, input_height, factor, resize_type);
